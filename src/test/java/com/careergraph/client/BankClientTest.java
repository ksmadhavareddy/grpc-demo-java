...
public class BankClientTest {
    ...
    public void withdrawTest(){
        ...
        WithdrawRequest withdrawRequest = WithdrawRequest.newBuilder().setAccountNmber(7).setAmount(40).build();
    ...
    public void withdrawAsyncTest(){
       ...
       WithdrawRequest withdrawRequest = WithdrawRequest.newBuilder().setAccountNmber(10).setAmount(50).build();
